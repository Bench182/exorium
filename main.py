...
async def serverinfo(ctx):
    ...
    embed.add_field(name="Creation Date", value=(ctx.guild.created_at.year) + (ctx.guild.created_at.month) + (ctx.guild.created_at.day) + (ctx.guild.created_at.hour), inline=True)
